...
TextPart.propTypes = {
  ...
  edit: PropTypes.bool,
  handlePartTextChange: PropTypes.func,
...
PromptBuilderPart.propTypes = {
  part: PropTypes.object,
  index: PropTypes.number,
  deletePromptItem: PropTypes.func,
  handleBuilderPartTextChange: PropTypes.func,
}

const PromptHistoryItem = (props) => {
  return props.item.parts.map((part, partIndex) =>
    <PromptHistoryPart {...props} part={part} partIndex={partIndex} key={partIndex}/>
  )
}
...
PromptHistoryPart.propTypes = {
  item: PropTypes.object,
  itemIndex: PropTypes.number,
  part: PropTypes.object,
  partIndex: PropTypes.number,
  deleteHistoryPart: PropTypes.object,
  handleHistoryPartTextChange: PropTypes.func,
}
